  ...
  <div class="container-fluid " style="background-color: #000000;">
     <div class="row">
         <div class="col-md-3 mt-5 text-white wow slideInLeft "  style="text-align: center;">
        ...
        <a href="https://www.linkedin.com/in/raspberry-solution-recruitment-and-outsourcing-company-in-nepal/" target="_blank">
         ...
         <div class="col-md-3 mt-5 wow slideInRight">

            <img src="{{asset('img/frontend_images/logo.png')}}" width="140px" height="40px"alt="" style="margin-left: 100px;">
